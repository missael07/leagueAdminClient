<template>
    <v-container grid-list-xs>
        <v-card outlined class="pa-3">
            ...
            <v-data-table :headers="playersHeaders" :items="team.rosters" height="430" items-per-page="3">
                <template #headers>
                    <tr>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <v-dialog v-model="dialogs[item.id]" width="auto">
                                <div class="ma-4">
                                    <v-img :width="300" aspect-ratio="16/9" class="bg-white" :src="item.imgUrl" cover />
                                </div>
                            </v-dialog>
                        </td>
                        <td align="center">
